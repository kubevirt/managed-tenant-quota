...
// MTQCRDs is a map containing yaml strings of all CRDs
var MTQCRDs map[string]string = map[string]string{
	"mtq": `apiVersion: apiextensions.k8s.io/v1
      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          metadata:
            type: object
          spec:
            description: MTQSpec defines our specification for the MTQ installation
            properties:
              certConfig:
              ...
              imagePullPolicy:
                ...
                type: string
              infra:
                description: Rules on which nodes MTQ infrastructure pods will be
                  scheduled
                properties:
                  affinity:
                    description: |-
                ...
                type: object
              priorityClass:
                description: PriorityClass of the MTQ control plane
                type: string
              workload:
            ...
            type: object
          status:
            description: MTQStatus defines the status of the installation
            properties:
              conditions:
...
status:
  ...
  storedVersions: null
`,
	"virtualmachinemigrationresourcequota": `apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
    controller-gen.kubebuilder.io/version: v0.14.0
...
spec:
  ...
  names:
    ...
    plural: virtualmachinemigrationresourcequotas
    shortNames:
    - vmmrq
    - vmmrqs
    singular: virtualmachinemigrationresourcequota
  scope: Namespaced
  versions:
  - name: v1alpha1
    schema:
