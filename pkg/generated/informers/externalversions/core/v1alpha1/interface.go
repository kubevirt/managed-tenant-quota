...
// VirtualMachineMigrationResourceQuotas returns a VirtualMachineMigrationResourceQuotaInformer.
func (v *version) VirtualMachineMigrationResourceQuotas() VirtualMachineMigrationResourceQuotaInformer {
	return &virtualMachineMigrationResourceQuotaInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
