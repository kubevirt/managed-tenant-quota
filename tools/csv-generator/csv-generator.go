...
var (
	...
	mtqLogoBase64 = flag.String("mtq-logo-base64", "", "")
	...
	dumpCRDs           = flag.Bool("dump-crds", false, "optional - dumps mtq-operator related crd manifests to stdout")
)

func main() {
	flag.Parse()

	data := mtqoperator.ClusterServiceVersionData{
		CsvVersion:         *csvVersion,
		ReplacesCsvVersion: *replacesCsvVersion,
		Namespace:          *namespace,
		ImagePullPolicy:    *pullPolicy,
		IconBase64:         *mtqLogoBase64,
		Verbosity:          *verbosity,

		OperatorVersion: *operatorVersion,

		ControllerImage:    *controllerImage,
		WebhookServerImage: *mtqLockServerImage,
		OperatorImage:      *operatorImage,
	}

	csv, err := mtqoperator.NewClusterServiceVersion(&data)
	if err != nil {
		panic(err)
	}
